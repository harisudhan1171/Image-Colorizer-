...
def colorizer(img):
    ...
    prototxt = r"PATH THAT WHERE THIS models_colorization_deploy_v2.prototxt FILE IS LOCATED"
    model = r"PATH THAT WHERE THIS colorization_release_v2.caffemodel FILE IS LOCATED"
    points = r"PATH THAT WHERE THIS pts_in_hull.npy FILE IS LOCATED"
